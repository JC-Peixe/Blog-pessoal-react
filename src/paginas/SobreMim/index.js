...
import fotoSobreMim from "assets/foto_sobre_peixe.webp";
...
export default function SobreMim() {
    return (
        ...
        >
            ...
            <img
                src={fotoSobreMim}
                alt="Foto do Peixe dando Aula na praia"
                className={styles.fotoSobreMim}
            />

            <p className={styles.paragrafo}>
                Oi, tudo bem? Eu sou o Peixe, futuro DeV Front-End e estou feliz de te ver por aqui.
            </p>
            <p className={styles.paragrafo}>
